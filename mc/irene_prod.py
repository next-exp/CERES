...
#open template
templates = { 'kr' : '/afs/cern.ch/user/j/jobenllo/newprod/templates/irene_kr.conf',
              'na' : '/afs/cern.ch/user/j/jobenllo/newprod/templates/irene_na.conf',
              'tl' : '/afs/cern.ch/user/j/jobenllo/newprod/templates/irene_tl.conf',
              'cs' : '/afs/cern.ch/user/j/jobenllo/newprod/templates/irene_cs.conf'}
